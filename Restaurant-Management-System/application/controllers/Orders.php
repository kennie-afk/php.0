...
class Orders extends Admin_Controller 
{
		...
		public function fetchOrdersData()
	{
		...
		foreach ($data as $key => $value) {
			...
			if(in_array('viewOrder', $this->permission)) {
				$buttons .= '<a target="__blank" href="'.site_url('orders/printDiv/'.$value['id']).'" class="btn btn-default"><i class="fa fa-print"></i></a>';
			}
		...
		public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {        	
        	...
        	if($order_id) {
        		...
        		redirect(site_url('orders/update/'.$id), 'refresh');
        	}
        	else {
        		$this->session->set_flashdata('errors', 'Error occurred!!');
        		redirect(site_url('orders/create/'), 'refresh');
        	}
        }
        else {
		...
		public function update($id)
	{
        ...
        if ($this->form_validation->run() == TRUE) {        	
        	...
        	if(empty($orders_data)) {
        		...
        		redirect(site_url('orders'), 'refresh');
        	}
