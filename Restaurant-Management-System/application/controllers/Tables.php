...
class Tables extends Admin_Controller 
{
	...
	{
		if(!empty($this->permission) && !in_array('viewTable', $this->permission)) {
		...
		foreach ($data as $key => $value) {
			...
			if(empty($this->permission) || in_array('updateTable', $this->permission)) {
				$buttons = '<button type="button" class="btn btn-default" onclick="editFunc('.$value['id'].')" data-toggle="modal" data-target="#editModal"><i class="fa fa-pencil"></i></button>';
			}

			if(empty($this->permission) || in_array('deleteTable', $this->permission)) {
