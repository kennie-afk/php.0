	...
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	if($create == true) {
        		...
        		redirect(site_url('groups/'), 'refresh');
        	}
        	else {
        		$this->session->set_flashdata('errors', 'Error occurred!!');
        		redirect(site_url('groups/create'), 'refresh');
        	}
        }
        else {
		...
		if($id) {
			...
			if ($this->form_validation->run() == TRUE) {
	        	...
	        	if($update == true) {
	        		...
	        		$this->session->set_flashdata('errors', 'Error occurred!!');
	        		redirect(site_url('groups/edit/'.$id), 'refresh');
	        	}
	        }
	        else {
			...
			if($this->input->post('confirm')) {
				...
				if($check == true) {
					...
					if($delete == true) {
		        		...
		        		redirect(site_url('groups/delete/'.$id), 'refresh');
		        	}
				}	
			}	
			else {
