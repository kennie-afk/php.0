  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <a href="<?php echo site_url('products/viewproduct') ?>" class="btn btn-success">View Product</a>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo site_url('products/remove') ?>" method="post" id="removeForm">
